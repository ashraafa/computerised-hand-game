...
* ### Use Case Testing
  ...
  * As a player of the game, I want to know the rules of the game.
    ...
    * Player can acces the rules via the Rules button when a round result message is displayed.
  ...
  * As a player of the game, I want to quit the game at any time.
    ...
    * Player can click the Quit button at anytime during the game.
...
The following section identifies websites and individuals that supported me whilst building the the game site.
